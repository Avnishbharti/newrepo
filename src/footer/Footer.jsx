    ...
    <footer className="bg-[#0e0e0e] text-white pt-16 pb-10">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-5 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li className="hover:text-white cursor-pointer">Wind Generators</li>
            <li className="hover:text-white cursor-pointer">Solar PV Materials</li>
            <li className="hover:text-white cursor-pointer">Battery Materials</li>
            <li className="hover:text-white cursor-pointer">Refined Products</li>
            <li className="hover:text-white cursor-pointer">Solar Modules</li>
            <li className="hover:text-white cursor-pointer">Biodiesel Fuel</li>
          </ul>
        </div>
